...
type Request struct {
	...
	xxx_hidden_Symbols    []string               `protobuf:"bytes,4,rep,name=symbols,proto3" json:"symbols,omitempty"`
	xxx_hidden_Timeseries *[]*TimeSeries         `protobuf:"bytes,5,rep,name=timeseries,proto3" json:"timeseries,omitempty"`
...
type TimeSeries struct {
	state                       protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_LabelsRefs       []uint32               `protobuf:"varint,1,rep,packed,name=labels_refs,json=labelsRefs,proto3" json:"labels_refs,omitempty"`
	xxx_hidden_Samples          *[]*Sample             `protobuf:"bytes,2,rep,name=samples,proto3" json:"samples,omitempty"`
	xxx_hidden_Histograms       *[]*Histogram          `protobuf:"bytes,3,rep,name=histograms,proto3" json:"histograms,omitempty"`
	xxx_hidden_Exemplars        *[]*Exemplar           `protobuf:"bytes,4,rep,name=exemplars,proto3" json:"exemplars,omitempty"`
	xxx_hidden_Metadata         *Metadata              `protobuf:"bytes,5,opt,name=metadata,proto3" json:"metadata,omitempty"`
	xxx_hidden_CreatedTimestamp int64                  `protobuf:"varint,6,opt,name=created_timestamp,json=createdTimestamp,proto3" json:"created_timestamp,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
type Metadata struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type    Metadata_MetricType    `protobuf:"varint,1,opt,name=type,proto3,enum=io.prometheus.write.v2.Metadata_MetricType" json:"type,omitempty"`
	xxx_hidden_HelpRef uint32                 `protobuf:"varint,3,opt,name=help_ref,json=helpRef,proto3" json:"help_ref,omitempty"`
	xxx_hidden_UnitRef uint32                 `protobuf:"varint,4,opt,name=unit_ref,json=unitRef,proto3" json:"unit_ref,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type Histogram struct {
	...
	xxx_hidden_ResetHint      Histogram_ResetHint    `protobuf:"varint,14,opt,name=reset_hint,json=resetHint,proto3,enum=io.prometheus.write.v2.Histogram_ResetHint" json:"reset_hint,omitempty"`
	xxx_hidden_Timestamp      int64                  `protobuf:"varint,15,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	xxx_hidden_CustomValues   []float64              `protobuf:"fixed64,16,rep,packed,name=custom_values,json=customValues,proto3" json:"custom_values,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
var file_io_prometheus_write_v2_types_proto_rawDesc = []byte{
	...
	0x09, 0x5a, 0x07, 0x77, 0x72, 0x69, 0x74, 0x65, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
